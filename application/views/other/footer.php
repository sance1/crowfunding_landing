<div class="container container-custom" style="background: #f0f0f5; padding: 10px;">
    <div class="col-12 text-justify footer-information-container pt-2 pb-2 pl-5 pr-5">
        <div class="features-intro text-center">
            <h2>"Untuk di Perhatikan"</h2>
        </div>
        <?php echo $untuk_di_perhatikan; ?>
    </div>
    <hr>
</div>
    ...
    <div class="container">
        <div class="row ml-0 mr-0">
            ...
            <div class="offset-md-3 col-md-6 text-center pt-3">
                ...
                <h6 class="mt-3 text-white">&copy; 2021 Obsido</h6>
                <br><br>
            </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/608d6aeb62662a09efc3f1c0/1f4k6jaa2';
s1.charset='UTF-8';
